namespace FontViewer {
    partial class FormMain {
        ...
        private void InitializeComponent() {
         ...
         this.panel2.Controls.Add(this.chkMonospace);
         ...
         this.tbxDir.Location = new System.Drawing.Point(260, 0);
         this.tbxDir.Name = "tbxDir";
         this.tbxDir.ReadOnly = true;
         this.tbxDir.Size = new System.Drawing.Size(480, 21);
         ...
         // chkMonospace
         // 
         this.chkMonospace.Dock = System.Windows.Forms.DockStyle.Left;
         this.chkMonospace.Location = new System.Drawing.Point(124, 0);
         this.chkMonospace.Name = "chkMonospace";
         this.chkMonospace.Size = new System.Drawing.Size(136, 21);
         this.chkMonospace.TabIndex = 5;
         this.chkMonospace.Text = "Mono Space Only";
         this.chkMonospace.UseVisualStyleBackColor = true;
         this.chkMonospace.CheckedChanged += new System.EventHandler(this.chkMonospace_CheckedChanged);
         // 
         // FormMain
         // 
